...
export default function Contracts({ open, handleClose }) {
  return (
    <Dialog
      ...
      fullWidth
    >
      <DialogTitle id="alert-dialog-title"  className='es__contact-dialogtitle'>
        <Stack direction="row" justifyContent="space-between" alignItems="center" spacing={2}>
          <Typography variant="h5" sx={{ fontWeight: 500 }} color="title.main">
            Contracts
          </Typography>
          <IconButton onClick={handleClose} aria-label="close" sx={{ bgcolor: '#121212' }}>
            <CloseIcon />
          </IconButton>
        </Stack>
      </DialogTitle>
      <DialogContent className='es__contact-dialogcontent'>
