...
const NetworkWalletProviders = ({
  ...
  return (
    <Dialog
      ...
      maxWidth="xs"
    >
      <DialogTitle id="alert-dialog-title" sx={{ p: 3 }} className='es__contact-dialogtitle'>
        <Stack direction="row" justifyContent="space-between" spacing={2}>
          <Box>
            <Typography variant="h6" sx={{ fontWeight: 500 }} color="title.main">
              Connect Wallet
            </Typography>
          </Box>
          <Box>
      ...
      <DialogActions className='es__contact-dialogaction'>
        <Button
          fullWidth
