...
const TeamSection = () => {
  return (
    <Box sx={{ py: 7, borderTop: 1, borderColor: '#1b2f1e' }}>
      <Container>
        <Box sx={{ maxWidth: '500px' }}>
          <Typography variant="h5" color="title.main" sx={{ mb: 1, fontWeight: 700 }}>
        ...
        <Grid container spacing={4} justifyContent="center">
          {members.map((member, i) => (
            <Grid item xs={12} md={4} key={i} className='es__team-member'>
              <Badge
                overlap="circular"
